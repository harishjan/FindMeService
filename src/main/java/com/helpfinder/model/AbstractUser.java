...
public abstract class AbstractUser implements User{
     ...
     */
    public AbstractUser(long userId, String address, String firstName, String lastname, String emailAddress, Set<UserRole> userRoles) 
    {
        this.userId = userId;
    ...
    public boolean hasPermission(UserPermissions permission) {
        for(UserRole role: getRoles()) {
            if(rolePermissionMapping.get(role.getUserRoleEnum()).contains(permission))
                return true;
        }
        return false;
    }
    ...
    @Override
    public Set<UserPermissions> getPermissions(UserPermissions permission) {
